...
import { couponInputSchema, couponUpdateSchema } from "../../../shared/couponTypes.js";

/**
 * /api/admin/coupons        → list (GET) / create (POST)
 * /api/admin/coupons?id=N   → update (PATCH) / delete (DELETE)
