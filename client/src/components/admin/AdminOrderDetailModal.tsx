...
import { fetchAdminOrder, type AdminOrderDetail, type AdminOrderItem } from "@/lib/api";
...
export default function AdminOrderDetailModal({ token, orderId, onClose }: Props) {
        ...
        {loading || !order ? (
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3">
              <span className="glass-chip px-3 py-1.5 text-xs font-bold uppercase tracking-widest text-accent" style={{ borderRadius: "8px" }}>
                {order.status}
              </span>
